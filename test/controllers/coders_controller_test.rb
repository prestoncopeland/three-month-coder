...
class CodersControllerTest < ActionController::TestCase
  ...
  test "should create coder" do
    assert_difference('Coder.count') do
      post :create, coder: { email: @coder.email, password: @coder.password, password_confirmation: @coder.password_confirmation, username: @coder.username }
    end
  ...
  test "should update coder" do
    patch :update, id: @coder, coder: { email: @coder.email, password: @coder.password, password_confirmation: @coder.password_confirmation, username: @coder.username }
    assert_redirected_to coder_path(assigns(:coder))
  end
